...
export default {
  ...
  onShareAppMessage: function () {
    ...
    shareObj = {
      ...
      // 分享标题
      // desc: '',
      path: `/pages/home/costManage/receiveCard/receiveCard?gifCardId=${this.wxShareId}`,
    ...
    handleSelectShareWayFun(e) {
      ...
      switch (e.currentTarget.dataset.type) {
        ...
        case 2:
          this.cancelShareFun(() => {
            uni.navigateTo({
              url: '/pages/home/costManage/giving/giving?origin=' + this.origin + '&id=' + this.id + '&money=' + this.money
            });
          });
          break;
