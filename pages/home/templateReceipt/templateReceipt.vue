<template>
<view>
<!--pages/home/templateReceipt/templateReceipt.wxml-->
...
<script>
// pages/home/templateReceipt/templateReceipt.js
...
export default {
  ...
  methods: {
    ...
    templateSelect(e) {
      ...
      uni.navigateTo({
        url: `/pages/home/receipt/receipt?templateName=${templateName}&templateAmount=${templateAmount}&isTemplate=${this.isTemplate}&templateId=${templateId}`
      });
    },
