...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.FXQ = void 0;
...
var FXQ = {
  ...
  commonMethod: function commonMethod(cType, fType) {
    var color = null;
  ...
  /**
      ...
      */
  companySeal: function companySeal(company, cType, fType, sType, seaNo, callback) {
    //获取canvans doc对象
  ...
  /**
      ...
      * @param type 类型
      */
  personal: function personal(name, cType, fType, type, border, callback) {
    this.commonMethod(cType, fType);
  ...
  //椭圆签章
  companyEllipse: function companyEllipse(company, serNo, fType, cType) {
    //椭圆长轴半径
    ...
    function writeFont(isTop, words) {
      ...
      for (var _i = 0; _i < fontTextLen; _i++) {
        var arcL = _i * arcPer + arcPer / 2;
        var ang = 0;
        ...
        var _x = radiusX * Math.cos(angR) + radiusX;
        var _y = radiusY * Math.sin(angR) + radiusY;
        var qxang = Math.atan2(radiusY * Math.cos(angR), -radiusX * Math.sin(angR));
        var fxang = qxang + Math.PI / 2;
        var subIndex = isTop == true ? _i : fontTextLen - 1 - _i;
        ...
        _x += h * minRat * Math.cos(fxang);
        _y += h * minRat * Math.sin(fxang);

        if (isTop) {
          _x += -w / 2 * Math.cos(qxang);
          _y += -w / 2 * Math.sin(qxang);
        } else {
          _x += w / 2 * Math.cos(qxang);
          _y += w / 2 * Math.sin(qxang);
        }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _basic = __webpack_require__(/*! ../mixins/basic */ 599);
var _index = __webpack_require__(/*! ../mixins/observer/index */ 600);function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.observe = observe;var _behavior = __webpack_require__(/*! ./behavior */ 601);
var _props = __webpack_require__(/*! ./props */ 602);
