...
/* 13 */
/*!*******************************************************************************!*\
  !*** /Users/icourt/Desktop/mycode/uni/main.js?{"page":"pages%2Fhome%2Fhome"} ***!
  \*******************************************************************************/
...
/* 14 */
/*!************************************************************!*\
  !*** /Users/icourt/Desktop/mycode/uni/pages/home/home.vue ***!
  \************************************************************/
/*! no static exports found */
...
/* 15 */
/*!*******************************************************************************************!*\
  !*** /Users/icourt/Desktop/mycode/uni/pages/home/home.vue?vue&type=template&id=92bb8f34& ***!
  \*******************************************************************************************/
...
/* 16 */
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/icourt/Desktop/mycode/uni/pages/home/home.vue?vue&type=template&id=92bb8f34& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var components = {
  homeAddDataStorge: function() {
    return __webpack_require__.e(/*! import() | components/home-add-dataStorge/home-add-dataStorge */ "components/home-add-dataStorge/home-add-dataStorge").then(__webpack_require__.bind(null, /*! @/components/home-add-dataStorge/home-add-dataStorge.vue */ 526))
  }
}
var render = function() {
  var _vm = this
...
/* 17 */
/*!*************************************************************************************!*\
  !*** /Users/icourt/Desktop/mycode/uni/pages/home/home.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 18 */
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/icourt/Desktop/mycode/uni/pages/home/home.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var app = getApp();var homeAddDataStorge = function homeAddDataStorge() {__webpack_require__.e(/*! require.ensure | components/home-add-dataStorge/home-add-dataStorge */ "components/home-add-dataStorge/home-add-dataStorge").then((function () {return resolve(__webpack_require__(/*! ../../components/home-add-dataStorge/home-add-dataStorge */ 526));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var sliderPicker = function sliderPicker() {__webpack_require__.e(/*! require.ensure | components/sliderPicker/sliderPicker */ "components/sliderPicker/sliderPicker").then((function () {return resolve(__webpack_require__(/*! ../../components/sliderPicker/sliderPicker */ 533));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { data: function data() {return { showDialog: false, mineSignCount: '0', otherSignCount: '0', hasAuth: false, fileName: '', userName: '', userList: [], sliderList: [{ label: '发起文件签署', value: 1 }, { label: '从合同模版发起签署', value: 2 }, { label: '取消', value: 2 }], authType: 1 // 未认证状态 1:个人 2:企业 
      , isLogin: "" };}, components: { homeAddDataStorge: homeAddDataStorge, sliderPicker: sliderPicker }, props: {}, onLoad: function onLoad() {}, onShow: function onShow() {this.initUserStatusOnLoadingFun();}, onUnload: function onUnload() {}, onShareAppMessage: function onShareAppMessage() {}, methods: { /**
          ...
          _this.setData({
            ...
            authType: 1,
            hasAuth: currentUser.companyId && currentUser.authStatus == 1 || currentUser.auth == 1 ? true : false });

          app.globalData.isAuth = currentUser.companyId && currentUser.authStatus == 1 || currentUser.auth == 1 ? true : false;
        },
    ...
    /**
        * @name 获取公司列表账户信息
        */
    getCompanyUserInfoFun: function getCompanyUserInfoFun() {var _this2 = this;
      uni.showLoading({
        title: '加载中' });
    ...
    /**
        * @name 跳转搜索页
        */
    handleToSearchPageFun: function handleToSearchPageFun() {
    ...
    /**
        * @name 关闭用户选择弹层
        */
    handleCloseUserDialogFun: function handleCloseUserDialogFun() {
      this.setData({
        showDialog: false });
    ...
    /**
        * @name 发起用户切换
        */
    handleLaunchUserSwitchFun: function handleLaunchUserSwitchFun() {
      if (!this.handleGetUserLoginStatusFun()) {
        app.globalData.login();
        return false;
      }
    ...
    switchUser: function switchUser(e) {
      ...
      var name = item.companyId ? item.companyName : item.name;
      console.log(item, 999);
      this.setData({
        userName: name ? name : '未认证用户',
        showDialog: false,
        authType: item.companyId ? 2 : 1,
        hasAuth: item.companyId && item.authStatus == 1 || !item.companyId && item.auth == 1 ? true : false });
    ...
    /**
        * @name 跳转创建企业
        */
    handleCreateCompanyFun: function handleCreateCompanyFun() {
      if (!this.handleGetUserLoginStatusFun()) {
        app.globalData.login();
        return false;
      }
    ...
    /**
        * @name 查看待自己处理合同
        */
    handleToViewContractForSelfFun: function handleToViewContractForSelfFun() {
      if (!this.handleGetUserLoginStatusFun()) {
        app.globalData.login();
        return false;
      }
    ...
    /**
        * @name 查看待他人处理合同
        */
    handleToViewContractForOthersFun: function handleToViewContractForOthersFun() {
      if (!this.handleGetUserLoginStatusFun()) {
        app.globalData.login();
        return false;
      }
    ...
    /**
        * @name 发起合同签署操作
        */
    handleLaunchContractFun: function handleLaunchContractFun() {
      // 未登陆直接前往登陆
      if (!this.handleGetUserLoginStatusFun()) {
        app.globalData.login();
        return false;
    ...
    /**
        * @name 通过文件上传发起合同
        */
    handleLaunchByfileFun: function handleLaunchByfileFun() {
      uni.chooseMessageFile({
        count: 1,
        type: 'file',
        success: function success(res) {
          var uploadFileName = res.tempFiles[0].name;
          var newfilename = res.tempFiles[0].name + ""; // 校验文件格式
      ...
      (0, _request.get)({
        ...
        success: function success(data) {
          _this3.setData({
            ...
            mineSignCount: data == 'undefined' ? 0 : data.myContractCount });
    ...
    /**
        * @name 获取用户登陆状态
        */
    handleGetUserLoginStatusFun: function handleGetUserLoginStatusFun() {
...
/* 19 */
/*!*********************************************************************************************!*\
  !*** /Users/icourt/Desktop/mycode/uni/pages/home/home.vue?vue&type=style&index=0&lang=css& ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 20 */
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/icourt/Desktop/mycode/uni/pages/home/home.vue?vue&type=style&index=0&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
